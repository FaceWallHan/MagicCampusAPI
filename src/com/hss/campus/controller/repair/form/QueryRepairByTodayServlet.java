...
//根据区域获取订单记录
@WebServlet(urlPatterns = "/getRepairListByToday")
public class QueryRepairByTodayServlet extends BaseRecordServlet {
    ...
    public Response operatePost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if (existAdministrator(id, name)){
            List<Repair> list = repairService.getRepairListByToday();
            if (list==null){
