...
//受理维修
@WebServlet(urlPatterns = "/queryAdministratorScheduleList")
public class QueryAdministratorScheduleServlet extends BaseRecordServlet {
    ...
    public Response operatePost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        List<Repair> repairList = repairService.queryByAdminSchedule( schedule);
